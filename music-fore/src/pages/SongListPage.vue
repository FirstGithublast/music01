  ...
  <div class="table">
    ...
    <el-table size="mini" border style="width:100%" heigt="680px" :data="data"@selection-change="handleSelectionChange">
      ...
      <el-table-column label="歌单管理" width="150" align="center">
        <template slot-scope="scope">
          <el-button size="mini" type="text" @click="listSongManage(scope.row.id)">歌单管理</el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="编辑歌单" :visible.sync="editVisible" width="400px" center>
      <el-form :model="editForm">
        ...
        <el-form-item prop="style" lobel="风格" size="mini">
...
<script>
  import {assSongList,getAllSongList,updateSongList,deleteSongList} from "../api/index"
  ...
  export default {
    ...
    methods:{
      ...
      addSongList(registerForm){
        assSongList(this.registerForm).then(res =>{
          if (res.code==1){
            this.getData();
